...
def generate_pointcloud_list(input_folder, output_file="point_cloud_list.yml",base_url="http://localhost:8686/img"):
    """
...
def main():
    parser = argparse.ArgumentParser(description="Generate YAML file listing all.ply files in a folder")
    parser.add_argument("input_folder", type=str, help="Path to folder containing.ply files")
    parser.add_argument("-o", "--output", type=str, default="point_cloud_list.yml", help="Output YAML file path")
    parser.add_argument("-b", "--base_url", type=str, default="http://localhost:8686/img", help="Base URL for the point cloud files")
