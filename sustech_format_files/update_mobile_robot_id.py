        ...
        if 'obj_id' in obj and 'obj_type' in obj:
            ...
            if obj['obj_type'] == target_obj_type:
                ...
                if old_id_str in id_mapping:
                    ...
                    print(f"  Found {target_obj_type} with obj_id {old_id} (no mapping defined)")
            # else:
...
def process_json_files(directory_path, id_mapping, target_obj_type="moving_mobile_robot", dry_run=False):
    """
    ...
    for file_path in json_files:
        ...
        try:
            ...
            updated_data, changes_made = update_robot_obj_ids(data, id_mapping, target_obj_type)
